...
const Events: React.FC<EventProps> = ({ date, time, title, desc }) => {
  return (
    <div className="grid h-[1/3vh] w-[1050px] grid-cols-7 items-center overflow-hidden rounded-lg">
      <div className="col-span-1 flex h-full items-center justify-center bg-[#2A7860]">
